...
function Contact() {
  return (
    <div name="contact"className="w-full h-screen bg-gradient-to-b from-black to bg-gray-800 text-white">
      <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
        ...
        <div className="flex justify-center">
            <form action="https://getform.io/f/60742e9d-bfdd-46b3-b5ef-a2287fd517c6" method="POST" className="flex flex-col">
               <input type="text"
               name="name"
